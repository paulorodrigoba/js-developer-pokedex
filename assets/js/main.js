document.documentElement.style.setProperty('--system-primary-color', getComputedStyle(document.documentElement).getPropertyValue('color'));
    ...
    <div class="header">
        ...
        <div class="back">
            <button onclick="closeModal(${pokemon.number})">
                <img src="./assets/imgens/arrow.png" alt="Voltar">
            </button>
        </div>

        <button class="heart ${likedParam}" onclick="likedToggle(this, ${pokemon.number})">
            <img src="./assets/imgagens/heart.png" alt="Coração">
        </button>
        </div>
        <div class="infos">
            <div class="detail">
